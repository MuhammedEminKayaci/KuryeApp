  ...
  return (
    <div className="min-h-screen w-full bg-white flex flex-col font-sans">
      <header className="bg-[#ff7a00] text-white py-3 px-6 flex items-center justify-between shadow relative">
        ...
        {/* Mobile Menu */}
        {isMenuOpen && (
          <div className="fixed inset-0 bg-[#ff7a00] z-40 md:hidden flex flex-col items-center justify-center">
            <nav className="flex flex-col items-center gap-8">
              <Link href="#" className="text-xl font-bold hover:text-white/80">Ana Sayfa</Link>
        ...
        <div className="hidden md:flex items-center gap-8">
          <nav className="flex gap-8 text-base font-bold items-center">
            <Link href="#" className="hover:text-white/80 text-black/80">Ana Sayfa</Link>
            <div className="w-[2px] h-6 bg-white"></div>
            <Link href="#" className="hover:text-white/80">İletişim</Link>
            <div className="w-[2px] h-6 bg-white"></div>
            <Link href="#" className="hover:text-white/80">Nasıl Çalışır</Link>
            <div className="w-[2px] h-6 bg-white"></div>
      ...
      <main className="flex-1 p-6 md:p-12 lg:p-20">
        ...
        <div className="max-w-6xl mx-auto px-6 mt-8">
          <div className="flex items-center justify-center gap-6">
            {[
              { icon: "/images/icon-kuryee.png", label: "1000+\nKurye" },
              { icon: "/images/icon-isletmee.png", label: "1000+\nİşletme" },
